<%@ Page Title="新闻编辑" Language="C#" MasterPageFile="~/user/admin/Site1.Master" AutoEventWireup="true" CodeBehind="MLJ_NewsC.aspx.cs" Inherits="MaiLeJi.user.admin.MLJ_NewsC" validateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <ol class="breadcrumb">
            <li class="active"><span class="glyphicon glyphicon-home"></span>&nbsp;新闻管理编辑</li>
        </ol>
        <div>
