<%@ Page Title="店铺编辑" Language="C#" MasterPageFile="~/user/admin/Site1.Master" AutoEventWireup="true" CodeBehind="MLJ_StoreC.aspx.cs" Inherits="MaiLeJi.user.admin.MLJ_StoreC" validateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <ol class="breadcrumb">
            <li class="active"><span class="glyphicon glyphicon-home"></span>&nbsp;店铺管理编辑</li>
        </ol>
        <div>
