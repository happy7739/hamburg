<?php /*a:5:{s:57:"F:\Project\hamburg\application\index\view\news\index.html";i:1590997529;s:58:"F:\Project\hamburg\application\index\view\public\base.html";i:1591259291;s:60:"F:\Project\hamburg\application\index\view\public\header.html";i:1591087968;s:58:"F:\Project\hamburg\application\index\view\public\menu.html";i:1590991790;s:60:"F:\Project\hamburg\application\index\view\public\footer.html";i:1591087968;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="lr_juzhong">
    <div>
        <div class="news-listbg">
            <div class="news-listset">
                <ul class="news-list">
                    ...
                    <li>
                        <a href="<?php echo url('index/news/index'); ?>?cat=<?php echo htmlentities($cat); ?>&id=<?php echo htmlentities($val['id']); ?>" title="<?php echo htmlentities($val['title']); ?>">
...
<div class="eng">
    ...
    <div class="eng_shan">
        ...
        <a href="<?php echo url('index/news/index'); ?>?cat=<?php echo htmlentities($cat); ?>&id=<?php echo htmlentities($up['id']); ?>"><?php echo htmlentities($up['title']); ?></a>
        <?php endif; ?>
    </div>
    <div class="eng_shan">
        下一篇：
        <?php if(!(empty($lo) || (($lo instanceof \think\Collection || $lo instanceof \think\Paginator ) && $lo->isEmpty()))): ?>
        <a href="<?php echo url('index/news/index'); ?>?cat=<?php echo htmlentities($cat); ?>&id=<?php echo htmlentities($lo['id']); ?>"><?php echo htmlentities($lo['title']); ?></a>
        <?php endif; ?>
    </div>
</div>
<?php endif; ?>
