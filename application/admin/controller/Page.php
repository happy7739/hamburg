...
class Page extends Admin
{
    ...
    public function add()
    {
        ...
        if ($this->request->isPost()) {
            ...
            if ($page = PageModel::create($data)) {
                // 记录行为
                action_log('page_add', 'admin_page', $page['id'], UID, $data['title']);
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->isPost()) {
            ...
            if (PageModel::update($data)) {
                // 记录行为
                action_log('page_edit', 'admin_page', $id, UID, $data['title']);
    ...
    public function quickEdit($record = [])
    {
        ...
        return parent::quickEdit(['page_edit', 'admin_page', $id, UID, $details]);
    }
}
